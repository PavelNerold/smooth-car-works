    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      {slides.map((slide, index) => (
        ...
        >
          <img
            src={slide}
            alt={`BP Autoservis - slide ${index + 1}`}
      ...
      <button
        onClick={prevSlide}
        className="absolute left-4 top-1/2 -translate-y-1/2 z-20 p-2 rounded-full bg-background/30 backdrop-blur-sm border border-border/30 text-foreground/70 hover:bg-background/50 hover:text-foreground transition-all"
      ...
      <button
        onClick={nextSlide}
        className="absolute right-4 top-1/2 -translate-y-1/2 z-20 p-2 rounded-full bg-background/30 backdrop-blur-sm border border-border/30 text-foreground/70 hover:bg-background/50 hover:text-foreground transition-all"
