  ...
  const mainServices = [
    {
      ...
      features: [
        ...
        { icon: Thermometer, label: "Klimatizace", desc: "Kontrola, servis, doplnění. Chladivo: R134a, 1234yf" },
      ],
      expanded: [
        ...
        "Výměna tlumičů a pružin",
        "Servis řízení a náprav",
        "Výměna spojky",
        "Diagnostika závad",
        "Geometrie kol",
        "Opravy výfukového systému",
        "Servis a plnění klimatizace",
        "Příprava a zajištění STK a emisí",
        "Výměna čelního skla",
      ],
    },
    {
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {mainServices.slice(1).map((service, index) => (
            <ScrollReveal key={service.title} delay={index * 100}>
              <div
                className="group bg-gradient-card rounded-2xl p-6 lg:p-8 border border-border/50 shadow-card hover:border-primary/30 transition-all duration-500 h-full"
              >
                {/* Icon */}
